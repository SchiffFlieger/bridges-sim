...
public class BridgeReferenceOrderTest {
    ...
    public static Collection<Object[]> data() {
        ...
        final Bridge valid1 = new Bridge(0, 0, 1, 2);
        final Bridge valid2 = new Bridge(1, 0, 6, 2);
        final Bridge valid3 = new Bridge(2, 3, 4, 2);

        final Bridge invalid1 = new Bridge(0, 6, 0, 2);
        final Bridge invalid2 = new Bridge(0, 2, 1, 2);
        final Bridge invalid3 = new Bridge(0, 5, 2, 2);
