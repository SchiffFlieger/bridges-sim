// TODO this whole test set may be unnecessary now

//package de.karstenkoehler.bridges.test.validators;
//
//import de.karstenkoehler.bridges.model.Bridge;
//import de.karstenkoehler.bridges.model.BridgesPuzzle;
//import de.karstenkoehler.bridges.io.validator.BridgeReferenceToIslandValidator;
...
//
//        final Bridge valid1 = new Bridge(0, islands.get(0), islands.get(5));
//        final Bridge valid2 = new Bridge(1, islands.get(2), islands.get(3));
//        final Bridge valid3 = new Bridge(2, islands.get(0), islands.get(5));
//
//        final Bridge invalid1 = new Bridge(3, islands.get(-1), islands.get(1));
//        final Bridge invalid2 = new Bridge(4, islands.get(1), islands.get(-1));
//        final Bridge invalid3 = new Bridge(5, islands.get(7), islands.get(0));
//        final Bridge invalid4 = new Bridge(6, islands.get(0), islands.get(7));
//        final Bridge invalid5 = new Bridge(7, islands.get(-1), islands.get(7));
//        final Bridge invalid6 = new Bridge(8, islands.get(7), islands.get(-1));
//
