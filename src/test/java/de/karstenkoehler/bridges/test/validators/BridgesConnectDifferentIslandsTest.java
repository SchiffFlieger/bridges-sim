...
public class BridgesConnectDifferentIslandsTest {
    ...
    public static Collection<Object[]> data() {
        ...
        final Bridge invalid1 = new Bridge(3, islands.get(0), islands.get(0));
        final Bridge invalid2 = new Bridge(4, islands.get(3), islands.get(3));
        final Bridge invalid3 = new Bridge(5, islands.get(6), islands.get(6));
