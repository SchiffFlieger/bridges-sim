...
public class BridgesConnectDifferentIslandsTest {
    ...
    public static Collection<Object[]> data() {
        ...
        final Connection invalid1 = new Connection(islands.get(0), islands.get(0));
        final Connection invalid2 = new Connection(islands.get(3), islands.get(3));
        final Connection invalid3 = new Connection(islands.get(6), islands.get(6));
